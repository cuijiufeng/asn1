...
public class JavaPoetUtil {
    ...
    public static Map.Entry<String, Object[]> builderReturnStatement(Definition definition) {
        if (Reserved.NULL.equals(definition.getPrimitiveType())) {
            return new AbstractMap.SimpleEntry<>("return new $T()",
            ...
            return new AbstractMap.SimpleEntry<>("return new $T(new BigInteger($S), new BigInteger($S))",
            ...
            return new AbstractMap.SimpleEntry<>("return new $T($L, $L)",
            ...
            return new AbstractMap.SimpleEntry<>("return new $T()",
                    new Object[]{ClassName.get(ASN1Sequence.class)});
